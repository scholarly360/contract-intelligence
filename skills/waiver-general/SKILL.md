...
name: waiver-general
description: >
  Clarifies that a party's failure to enforce a contractual right on one occasion does not permanently waive that right.
  Preserves the full enforceability of all terms despite occasional leniency or delayed action.
---
